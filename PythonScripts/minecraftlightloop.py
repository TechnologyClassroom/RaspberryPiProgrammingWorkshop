...
# This starts a loop.  It will only stop if the program is stopped with CTRL + C or by closing the terminal in which it is running.
while True:
	...
	mc.postToChat("MrMike erases MIKE")
	
	# M
	mc.setBlock(5, 14, 5, block.AIR)
	mc.setBlock(5, 13, 5, block.AIR)
	mc.setBlock(5, 12, 5, block.AIR)
	mc.setBlock(5, 11, 5, block.AIR)
	mc.setBlock(5, 10, 5, block.AIR)
	mc.setBlock(5, 13, 6, block.AIR)
	mc.setBlock(5, 12, 7, block.AIR)
	mc.setBlock(5, 13, 8, block.AIR)
	mc.setBlock(5, 14, 9, block.AIR)
	mc.setBlock(5, 13, 9, block.AIR)
	mc.setBlock(5, 12, 9, block.AIR)
	mc.setBlock(5, 11, 9, block.AIR)
	mc.setBlock(5, 10, 9, block.AIR)
	
	# I
	mc.setBlock(5, 10, 11, block.AIR)
	mc.setBlock(5, 11, 11, block.AIR)
	mc.setBlock(5, 12, 11, block.AIR)
	mc.setBlock(5, 13, 11, block.AIR)
	mc.setBlock(5, 14, 11, block.AIR)
	
	# K
	mc.setBlock(5, 14, 13, block.AIR)
	mc.setBlock(5, 13, 13, block.AIR)
	mc.setBlock(5, 12, 13, block.AIR)
	mc.setBlock(5, 11, 13, block.AIR)
	mc.setBlock(5, 10, 13, block.AIR)
	mc.setBlock(5, 12, 14, block.AIR)
	mc.setBlock(5, 11, 15, block.AIR)
	mc.setBlock(5, 13, 15, block.AIR)
	mc.setBlock(5, 10, 16, block.AIR)
	mc.setBlock(5, 14, 16, block.AIR)
	
	# E
	mc.setBlock(5, 14, 18, block.AIR)
	mc.setBlock(5, 13, 18, block.AIR)
	mc.setBlock(5, 12, 18, block.AIR)
	mc.setBlock(5, 11, 18, block.AIR)
	mc.setBlock(5, 10, 18, block.AIR)
	mc.setBlock(5, 10, 19, block.AIR)
	mc.setBlock(5, 14, 19, block.AIR)
	mc.setBlock(5, 12, 19, block.AIR)
	mc.setBlock(5, 10, 20, block.AIR)
	mc.setBlock(5, 14, 20, block.AIR)
	
	# Water
	mc.setBlock(5, 10, 23, block.AIR)
